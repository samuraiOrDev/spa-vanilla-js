    ...
    <style>${Contact.styles}</style>
        <section id="contact">
          <div class="contact-title">
            <div class="title">
                <h2><span class='primary'>/</span>contacts</h2>
          ...
          <div class='about-content'>
            ...
            <div style="" class='container-contact-social'>
              <div class='contact-social'>
                  <p class='white'>Support me here</p>
                  <span class='gray'>4149500120690030</span>
              </div>
              <div class='contact-social'>
                  <div>
...
customElements.define('contact-section-component', Contact);
